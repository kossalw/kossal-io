...
We have seen how arrays are collections of other data types like text, numbers or others. In some ocasions we want to work with the elements of the array as if they were in their own row, so we can use the set generating function of `unnest`:
